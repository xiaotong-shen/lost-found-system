...
public class DeletePostInputData {
    ...
    public DeletePostInputData(String action) {
        this.action = action;
    ...
    public DeletePostInputData(String action, String searchQuery) {
        this.action = action;
    ...
    public DeletePostInputData(String action,String postId, String postTitle, String postContent,
    ...
    public DeletePostInputData(String action, String postTitle, String postContent,
